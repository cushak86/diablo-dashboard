...
//
// ⚠️ 이 규칙은 지금까지 **세 번 깨졌다.** 색인관제 로그 4회차에 한 번(lastmod 5건),
...
export const SITE_PAGES = [
  ...
  { path: "/runewords", lastModified: "2026-07-30", changeFrequency: "monthly", priority: 0.4,
    title: "룬워드 조합", summary: "룬워드 99종의 룬 순서·소켓 수·베이스·요구 레벨. 3.0~3.2 신규 7종 포함. 한글·영문·룬 검색." },
  { path: "/new-items", lastModified: "2026-07-30", changeFrequency: "weekly", priority: 0.7,
