...
// 출처: diablo2.io price-check(완료 거래 기반) 1차 앵커 · 커뮤니티 룬 밸류 리스트 2차.
// as-of는 AS_OF 상수 하나가 정본이다 — 주석·UI에 손으로 박지 말 것(갱신 시 한 곳만 고친다).
...
// 기준선 수집 시점. 값을 갱신하면 이 상수도 함께 올린다.
export const AS_OF = "2026-07";

// 기준선이 얼마나 오래됐는가(개월). 갱신 트리거가 없는 정적 데이터라, 화면이 스스로 나이를 말하게 한다.
export function monthsSinceAsOf(now = new Date()) {
  const [y, m] = AS_OF.split("-").map(Number);
  return (now.getFullYear() - y) * 12 + (now.getMonth() + 1 - m);
}

// 이 개월 수를 넘기면 화면에 "오래됨" 경고를 띄운다.
...
export const BASELINE = [
  ...
  { key: "grief", kr: "슬픔", en: "Grief", tier: "S", std: "≈2~4 Ber", ladder: "≈4~7 Ber", note: "페이즈블레이드+고피해 롤이면 10 HR 이상까지." },
  ...
  { key: "fortitude", kr: "인내", en: "Fortitude", tier: "A", std: "≈Lo (10~14 Ist)", ladder: "≈1~2 Ber", note: "에테리얼 아처 베이스면 프리미엄. 래더 초 인기." },
  { key: "heart-of-the-oak", kr: "참나무의 심장", en: "Heart of the Oak", tier: "A", std: "≈Ohm~Lo (5~14 Ist)", ladder: "≈Lo~1.5 Ber", note: "프레일/지팡이 베이스. 캐스터 무기." },
  { key: "chains-of-honor", kr: "명예의 굴레", en: "Chains of Honor", tier: "A", std: "≈Um~Lo", ladder: "≈Lo~1 Ber", note: "저항·물감쇄 갑옷. 아처/두라 베이스면 상승." },
  ...
  { key: "bramble", kr: "찔레", en: "Bramble", tier: "B", std: "≈Ohm~Lo", ladder: "≈Lo~1 Ber", note: "가시 오라·+독피해 갑옷. 독네크/드루." },
  { key: "insight", kr: "통찰", en: "Insight", tier: "B", std: "≈Ral~Um", ladder: "≈Pul~Um", note: "명상 오라 용병 폴암. 저비용 고수요 마나 유지템." },
  { key: "spirit", kr: "영혼", en: "Spirit", tier: "B", std: "≈Ral~Um", ladder: "≈Thul~Ohm", note: "+2스킬·FCR 검/방패. 초반 국민 캐스터템, 저비용 고수요." },
  ...
  { key: "fury", kr: "분노", en: "Fury", tier: "C", std: "≈Um~Mal", ladder: "≈Um~Lo", note: "근접 물리. 저비용 고피해." },
  ...
  { key: "oath", kr: "서약", en: "Oath", tier: "C", std: "≈Ral~Thul", ladder: "≈Thul~Um", note: "파괴불가 근접. 저비용." },
  { key: "lawbringer", kr: "집행자", en: "Lawbringer", tier: "C", std: "≈Ral~Thul", ladder: "≈Thul~Um", note: "성역 오라·감속 프록. 저비용 유틸." },
  ...
  { key: "obedience", kr: "순종", en: "Obedience", tier: "C", std: "≈Ral~Thul", ladder: "≈Thul~Um", note: "가성비 용병 폴암. 저항·강타." },
  { key: "duress", kr: "협박", en: "Duress", tier: "C", std: "≈Ral~Thul", ladder: "≈Thul~Um", note: "강타·개막 갑옷. 저비용 근접." },
  ...
  { key: "lionheart", kr: "용맹", en: "Lionheart", tier: "C", std: "≈Ral~Thul", ladder: "≈Thul~Um", note: "능력치·저항 초중반 갑옷. 저렴." },
  ...
  { key: "rhyme", kr: "각운", en: "Rhyme", tier: "D", std: "≈Ral~Thul", ladder: "≈Thul~Ko", note: "얼지않음·MF 방패. 저렴." },
  { key: "ancient-s-pledge", kr: "고대인의 서약", en: "Ancient's Pledge", tier: "D", std: "≈El~Ral", ladder: "≈Ral~Thul", note: "초반 저항 방패. 매우 저렴." },
  { key: "stealth", kr: "잠행", en: "Stealth", tier: "D", std: "≈El~Ith", ladder: "≈Ral~Thul", note: "초반 국민 갑옷. 매우 저렴." },
  { key: "lore", kr: "전승", en: "Lore", tier: "D", std: "≈El~Ral", ladder: "≈Ral~Thul", note: "+1스킬 초반 투구. 매우 저렴." },
  ...
  // kr "오움 룬" = 2026-07-30 사장님 실측 확정(기존 "옴 룬"은 커뮤니티 값). aka로 옛 표기 검색 도달 유지
  // — 이름만 갈고 alias를 안 남기면 "옴" 검색이 죽는다(2026-07-17 룬워드 개명 때 배운 회귀).
  { key: "ohm", kr: "오움 룬", aka: "옴 룬", en: "Ohm Rune", tier: "HR", std: "≈6~8 Ist", ladder: "≈5~7 Ist", note: "피해증가 룬워드 다수. 중상위 통화." },
  { key: "vex", kr: "벡스 룬", en: "Vex Rune", tier: "HR", std: "≈3~4 Ist", ladder: "≈2.5~3 Ist", note: "HotO·불사조 등. 하위 고룬 통화." },
  { key: "cham", kr: "참 룬", en: "Cham Rune", tier: "HR", std: "≈4 Ist", ladder: "≈3~4 Ist", note: "얼지않음. 안개·역병 재료. 수요 특수." },
