...
// 스키마: { id, class, name, tags[], skills:[{name,priority,points?,note}], stats(문자열), keyRunewords[en], breakpointGoal:{fcr,fhr}, tier:{overall,ladder,density}, mercenary, note, sources[url], verify? }
