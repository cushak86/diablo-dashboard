...
export const FARM_TARGETS = [
  ...
  {
    // 표시명 "오움 룬" — 2026-07-30 사장님 게임 클라이언트 실측 확정(기존 "옴 룬"은 커뮤니티 값이었다).
    // 옛 표기 "옴"은 alias로 유지 — 사내·커뮤니티가 그렇게 불러왔으니 검색은 계속 닿아야 한다.
    id: "rune-ohm", kr: "오움 룬", en: "Ohm Rune", type: "rune", itemCode: "r27",
    alias: ["오움 룬", "오움", "옴 룬", "옴", "Ohm", "Ohm Rune", "r27", "ㅇ", "ㅇㄹ"],
    spots: { plain: ["countess", "andariel", "mephisto", "diablo", "baal", "pindleskin", "cows"], tz: [] },
    tcPath: ["Runes 14", "r27"],
  ...
  },
  {
    ...
    // 표시·note는 게임 표기 정본(2026-07-30 사장님 실측: Thul=주울·Eth=에드·Amn=앰).
    // 옛 표기(툴·암·엣)는 alias로 남긴다 — 사내에서 그렇게 불러왔으니 검색은 계속 닿아야 한다
    // (자/조·이스트/아이스트·참/샴과 같은 처리). 표기 정본은 lib/rune-names.js.
    alias: ["저급 룬", "하급 룬", "잡룬", "Tal", "Thul", "Ort", "Amn", "Ral", "Tir", "Sol", "Eth", "El", "Dol", "탈", "주울", "오르트", "앰", "랄", "티르", "솔", "에드", "엘", "돌", "툴", "암", "엣"],
    spots: { plain: ["countess", "andariel", "mephisto", "diablo", "baal", "pindleskin", "cows"], tz: [] },
    tcPath: ["Runes 6", "r11"], // 묶음 중 게이트가 가장 높은 Amn(r11) 기준
    links: { planner: true, cube: true, prices: null, terrorZone: true, grail: null },
    note: "정신·통찰·불굴 같은 초반 룬워드의 재료가 되는 저급 룬(탈·주울·오르트·앰·랄·티르·솔·에드·엘·돌)은 조건이 낮아 아래 모든 곳에서 공포의 영역 없이도 나옵니다. 초반부터 자연히 모입니다.",
  ...
  },
  {
    ...
    note: "재료 중 오움 룬의 조건이 가장 높지만, 그래도 아래 모든 곳이 공포의 영역 없이 도달합니다.",
