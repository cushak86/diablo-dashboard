    ...
    <main>
      <div className="wrap stack">
        <div className="card">
          ...
          <p className="zen">
            낮은 룬을 <b>같은 룬 여러 개(+보석)</b>로 큐브에 돌려 상위 룬으로 업그레이드합니다. 엘~주울(Thul)까지는 같은 룬
            3개, <b>우움(Um)부터</b>는 2개 + 지정 보석이 필요합니다. 룬워드용 고급 룬 파밍의 핵심 도구입니다.
          </p>
        </div>
        ...
        <div className="note">
          <b>파밍 팁</b> — 룬워드용 고급 룬(우움~조드)은 드롭이 극히 드물어 <b>저급 룬 업그레이드</b>가 현실적입니다.
          카운테스(액트1 망각의 탑)·헬포지 퀘스트·공포의 영역(TZ) 런으로 저급 룬과 보석을 대량 확보한 뒤 큐브로 압축하세요.
          <br />
          <b>규칙 요약</b> — 엘→주울(Thul)까지는 같은 룬 3개. <b>앰(Amn)부터 보석 추가</b>. <b>우움(Um)부터</b>는 2개 + 보석.
