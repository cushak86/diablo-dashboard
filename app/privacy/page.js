    ...
    <main>
      <div className="wrap stack">
        <div className="card">
          ...
          {/* ⚠️ 여기에 "제3자 추적 쿠키를 쓰지 않는다"고 단정해 두지 마라 (2026-08-14 수정).
              2026-08-09 에 쿠팡 제휴 광고를 붙였는데 이 문장과 7항을 함께 안 고쳐서, **방침이
              거짓인 채로 라이브에 떠 있었다.** 애드센스를 붙이면 구글 광고 쿠키가 실제로 들어온다.
              방침은 사이트가 하는 일을 따라가야 한다 — 반대가 아니다. */}
          <p style={S}>
            위 셋은 이 사이트가 직접 설정하는 쿠키입니다. 광고와 관련된 제3자 쿠키는 7항을 보세요.
          </p>
          ...
          {/* ⚠️ 2026-08-14 전면 교체. 전에는 "현재 서비스에는 광고가 없습니다"라고 적혀 있었는데
              2026-08-09 에 쿠팡 제휴 광고를 붙이면서 이 문장을 안 고쳤다 — **방침이 거짓인 채로
              닷새를 라이브에 떠 있었다.** 광고를 붙이거나 뗄 때 이 절을 같이 고쳐라.
              애드센스 심사자는 이 페이지를 반드시 본다. 광고에 대한 거짓은 누락보다 나쁘다. */}
          <div style={HD}>7. 광고</div>
          <p style={S}>
            이 사이트는 <b>쿠팡 파트너스 제휴 링크</b>를 싣고 있으며, 이에 따른 일정액의 수수료를
            제공받습니다. 상품 목록은 쿠팡 파트너스 API 를 통해 <b>이 사이트의 서버가</b> 받아 오며, 그 과정에서
            여러분의 정보는 쿠팡에 전달되지 않습니다. 다만 상품 사진은 쿠팡의 광고 서버(ads-partners.coupang.com)에서
            직접 불러오므로 <b>사진이 표시될 때 여러분의 브라우저가 쿠팡 서버에 이미지 요청을 보냅니다</b>(이때 이 사이트는
            리퍼러를 보내지 않도록 설정했습니다). 제휴 링크는 누르기 전에는 그 밖의 어떤 정보도 외부로 보내지 않습니다.
            API 를 쓸 수 없을 때는 이 사이트가 직접 제공하는 이미지의 정적 배너가 대신 표시됩니다.
          </p>
          <p style={S}>
            또한 <b>구글 애드센스</b> 광고 도입을 준비하고 있습니다. 도입되면 다음이 적용됩니다.
          </p>
          <ul style={{ margin: 0, paddingLeft: 18 }}>
            <li style={LI}>
              구글을 포함한 <b>제3자 공급업체가 쿠키를 사용해</b> 광고를 게재합니다.
            </li>
            <li style={LI}>
              구글은 광고 쿠키를 사용해, 사용자가 <b>이 사이트나 다른 사이트를 방문한 기록</b>을
              바탕으로 광고를 표시합니다.
            </li>
            <li style={LI}>
              맞춤 광고를 원하지 않으시면{" "}
          ...
          <p style={S}>
            광고 목적으로 <b>이 사이트가 직접 개인정보를 수집하거나 제3자에게 넘기지 않습니다.</b>
            1~3항의 진행 데이터·방문 통계는 광고와 연결되지 않습니다.
          </p>
