export const metadata = {
  ...
  description:
    "디아블로2 레저렉션(D2R) 드롭 위치 가이드. 베르·자·이스트 룬, 수수께끼(Enigma)·영혼(Spirit)·소집(CTA) 등 룬워드 재료, 조던의 돌(SoJ)이 어느 몬스터·지역에서 나올 수 있는지 게임 데이터의 드롭 표에서 직접 추출해 한글로 정리. 한글명·초성·영문명 검색. 공포의 영역에서만 열리는 경로도 구분해 표시. 지옥(Hell) 기준.",
