...
**🔗 라이브: https://diablo-dashboard-phi.vercel.app** — 설치 없이 브라우저에서 바로 쓰는 디아블로2 레저렉션(D2R) 통합 대시보드입니다. 실시간 공역(테러존) 타이머·음성 알림, 룬 재고로 만들 수 있는 룬워드 판정, 홀리 그레일 체크리스트, 드롭 위치 가이드 등을 제공합니다.
