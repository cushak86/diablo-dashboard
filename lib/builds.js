...
export const BUILDS = [
  ...
  },
  {
    ...
    "note": "마법 데미지라 원소 면역 무관·관통 우수. 뼈 계열 5스킬 전부 최대 투자(상호 시너지). 스킬 순서 상충: 맥스롤 뼈 창 우선(광역) / 아이시베인즈 뼈 정령 우선(단일) — 최대 투자 집합은 동일. 시전 속도 125%(9프레임): 참나무의 심장+거미줄 그물 핵심. 순백은 예산 완드(+뼈창/뼈 스킬).",
    "sources": [
